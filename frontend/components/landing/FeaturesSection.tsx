...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="w-full py-14 md:py-[72px] lg:py-24 bg-white relative">
        ...
        >
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className={`w-14 h-14 rounded-xl ${feature.bgColor} flex items-center justify-center mb-6 transition-transform duration-300 ease-out group-hover:scale-110 group-hover:-rotate-3 shrink-0`}>
                <feature.icon className={`w-7 h-7 ${feature.color}`} />
              </div>
              
              <h3 className="text-xl font-bold text-[#0F172A] mb-3 group-hover:text-[#168BFF] transition-colors duration-300">
                {feature.title}
              </h3>
