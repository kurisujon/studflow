...
export function LandingFooter() {
  return (
    <footer className="w-full bg-[#0a0e1a] border-t border-white/10 flex flex-col items-center pt-20 pb-10">
      <div className="w-full max-w-7xl px-4 sm:px-6 mx-auto flex flex-col md:flex-row justify-between items-start gap-12 md:gap-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-16 gap-y-10">
          <div className="flex flex-col gap-4">
            ...
            <Link href="/sign-up" className="text-white/60 hover:text-white text-sm transition-colors">Sign up</Link>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-white font-semibold mb-2 text-sm">Resources</h4>
            <Link href="/docs" className="text-white/60 hover:text-white text-sm transition-colors">Documentation</Link>
            <Link href="#" className="text-white/60 hover:text-white text-sm transition-colors">Help Center</Link>
            <Link href="#" className="text-white/60 hover:text-white text-sm transition-colors">Blog</Link>
          </div>
          <div className="flex flex-col gap-4 col-span-2 sm:col-span-1">
            ...
            <Link href="mailto:support@studflow.com" className="text-white/60 hover:text-white text-sm transition-colors">Contact</Link>
          </div>
        </div>
      </div>

      <div className="w-full max-w-7xl px-4 sm:px-6 mx-auto mt-20 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <p className="text-white/40 text-sm font-light flex items-center gap-2">
          Designed for better learning <span className="text-indigo-500">✦</span>
        </p>
      </div>
    </footer>
  );
