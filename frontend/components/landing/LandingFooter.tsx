...
export function LandingFooter() {
  ...
  return (
    <footer className="w-full bg-[#F8FAFC] border-t border-[#E2E8F0] pt-16 sm:pt-24 lg:pt-32 pb-12">
      <LandingContainer variant="default">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
          ...
          <div>
            <h4 className="font-semibold text-[#0F172A] mb-4 text-base">Product</h4>
          ...
          <div>
            <h4 className="font-semibold text-[#0F172A] mb-4 text-base">Support</h4>
            <ul className="space-y-3">
              <li><Link href="#faq" className="text-[#64748B] hover:text-[#168BFF] text-sm transition-colors">FAQ</Link></li>
          ...
          <div>
            <h4 className="font-semibold text-[#0F172A] mb-4 text-base">Connect</h4>
            <div className="flex gap-4">
              <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-white border border-[#E2E8F0] flex items-center justify-center text-[#64748B] hover:text-[#168BFF] hover:border-[#168BFF]/30 hover:shadow-sm transition-all">
              ...
              <a href="#" aria-label="GitHub" className="w-10 h-10 rounded-full bg-white border border-[#E2E8F0] flex items-center justify-center text-[#64748B] hover:text-[#168BFF] hover:border-[#168BFF]/30 hover:shadow-sm transition-all">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-white border border-[#E2E8F0] flex items-center justify-center text-[#64748B] hover:text-[#168BFF] hover:border-[#168BFF]/30 hover:shadow-sm transition-all">
