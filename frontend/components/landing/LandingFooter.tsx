...
export function LandingFooter() {
  ...
  return (
    <footer className="w-full bg-background border-t border-border flex flex-col items-center pt-16 pb-8">
      ...
      <div className="w-full max-w-7xl px-6 mt-16 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
